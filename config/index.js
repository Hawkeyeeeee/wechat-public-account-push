export const config = {
  ...
  USERS: [
    {
      ...
      id: "oSa2s6aRS_PAi1bYd8ItK9u8-hXE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "wuba8SalbwgNp5EnaeSt8pq-o25FO8LSr2P3NFmo2FQ",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "青岛",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1995", "date": "01-13"},
        {"type": "*生日", "name": "老公", "year": "1992", "date": "06-07"},
        
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2020-10-05"},
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: "viiGY5pfS1Q1KMqIf7RtsCV6YPwjf6oDMGH0pySnJ-E",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oSa2s6eDG0xAyFHGaYiC5Ln4cDDI",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
